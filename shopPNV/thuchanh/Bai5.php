...
<body>
	...
	?>
	<form action="?option=Bai5" method="post" >
		<table width="806" border="1">
			<tr>
				<td colspan="4" bgcolor="#0066FF" align="center"><strong>Giải phương trình bậc 2</strong>
				</td>
			</tr>
			<tr>
				<td width="100">Phương trình </td>
			...
			<tr>
				<td colspan="4" align="center" valign="middle" bgcolor="#FF0000"><input type="submit" name="chao" id="chao" value="Xuất" /></td>
			</tr>
		</table>
	</form>
</body>
