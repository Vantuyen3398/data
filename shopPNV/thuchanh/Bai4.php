...
<body>
	...
	?>
	<form action="?option=Bai4" method="post" >
	 
		<table width="728" border="1">
			<tr>
				<td width="122">&nbsp;</td>
				<td width="76" bgcolor="#00FFFF">Số bắt đầu</td>
				<td width="169" bgcolor="#00FFFF">
					<label for="textfield"></label>
					<input type="text" name="so_dau" id="textfield" value="<?php if (isset($_POST["so_dau"])) echo $_POST["so_dau"];?> "/>
				</td>
				<td width="152" bgcolor="#00FFFF">Số kết thúc</td>
				<td width="175" bgcolor="#00FFFF">
					<label for="textfield2"></label>
					<input type="text" name="so_cuoi" id="textfield2" value="<?php if (isset($_POST["so_cuoi"])) echo $_POST["so_cuoi"];?> "/>
				</td>
			</tr>
			<tr>
				<td colspan="5" align="center" bgcolor="#0066FF">Kết quả
